...
![Expo](https://img.shields.io/badge/Expo-SDK%2054-000?logo=expo&logoColor=fff)
...
```bash
# 1. Entre na pasta deste projeto (o repositório também guarda o app do professor)
cd planeja

# 2. Instale as dependências
pnpm install

# 3. Configure o ambiente (aponte para o IP da sua máquina na rede local)
cp .env.example .env
...
<div align="center">
<sub>Documento de escopo completo em <a href="../docs/EscopoPlanejaMobile.pdf"><code>docs/</code></a> · Projeto base do professor em <a href="../base-professor/"><code>base-professor/</code></a> · Entrega: 17 de dezembro de 2026</sub>
</div>
